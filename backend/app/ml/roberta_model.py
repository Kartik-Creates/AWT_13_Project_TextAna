...
class RobertaAnalyzer:
    """Text toxicity analysis using multilingual XLM-RoBERTa toxicity model.
    
    Supports English AND Hindi/Hinglish through:
      1. ML model: unitary/multilingual-toxic-xlm-roberta
         — outputs toxicity labels via sigmoid
    ...
    def __init__(self):
        self.model, self.tokenizer = model_loader.load_roberta()
